...
// Middleware Express. Bloqueia tudo, exceto requisições com o header
// 'x-render-token' válido — usado internamente pelo Puppeteer para
// renderizar o catálogo durante a geração de PDF sem precisar autenticar.
function middleware() {
  return (req, res, next) => {
